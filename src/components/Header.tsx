      ...
      >
        <div className="max-w-5xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between">
          <div className="flex items-center gap-3 sm:gap-6">
            <a
              href="/"
              className="flex items-center focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent focus-visible:rounded-md p-1 -m-1"
            >
            ...
            <div className="flex bg-muted/80 border border-border rounded-full p-1 relative shadow-sm">
              ...
              <div
                className={cn(
                  "absolute top-1 bottom-1 w-[calc(33.333%-2.67px)] bg-background shadow-md rounded-full transition-all duration-300 ease-out z-0 border border-border",
                  getSliderPosition(),
                )}
              />
            </div>
